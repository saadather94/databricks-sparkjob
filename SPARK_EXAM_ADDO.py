...
from pyspark.sql.functions import regexp_extract, regexp_replace,avg, col
...
# For this task I had uploaded the recipe files to my Azure storage and perform operations 
